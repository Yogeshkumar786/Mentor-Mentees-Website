...
function LoginPage() {
    ...
    const { setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleDirectSignIn = async (role)=>{
        ...
        setLoading(true);
        try {
            const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(role, "password");
            if (user) {
                setUser(user);
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
            if (!user) {
...
_s(LoginPage, "Hl1l4pbBY8Mu9xgsopCd0euoDDA=", false, function() {
    return [
...
//# sourceMappingURL=_b47d6d18._.js.map