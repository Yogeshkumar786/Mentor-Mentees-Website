...
class ApiService {
    ...
    async getStudentMentors() {
        return this.request('/api/student/mentors');
    }
    async getMentorshipMeetings(mentorshipId) {
        return this.request(`/api/student/mentorship/${mentorshipId}/meetings`);
    }
}
...
function AuthProvider({ children }) {
    ...
    const refreshUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getMe();
            setUser(userData);
        } catch (error) {
            setUser(null);
        }
    ...
    const changePassword = async (oldPassword, newPassword)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].changePassword(oldPassword, newPassword);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2364ce71._.js.map